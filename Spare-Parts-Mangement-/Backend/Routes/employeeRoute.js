...
const { registerEmployee, loginEmployee, logout, getEmployee, loginStatus,  updateEmployee, changePassword , deleteEmployee,  getAllEmployees, searchEmployee,printEmpID } = require("../Controllers/employeeController");
